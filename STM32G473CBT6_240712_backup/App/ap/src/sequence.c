...
float  vpp_out         = 0.0f;       // vpp (default 0Vpp)
float  algo_vpp_out    = 0.0f;       // vpp (default 0Vpp)
uint16_t freq          = 0;                         // dac freq hz (default 30hz)
uint16_t algo_freq     = 0;                         // dac freq hz (default 30hz)
bool  iscli = 0;
bool  isalgo = 0 ;
